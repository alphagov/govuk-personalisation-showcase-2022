...
//PHASE 2 ROUND 4 ROUTES
// childcare calc account logic
router.post('/phase-2-round-4/sign-in-or-create-account-form', function (req, res) {
    ...
    if (option === 'create-account') {
        // Send user to this page
        res.redirect('/phase-2-round-4/account/create-account-enter-email')
    } else if (option === 'signin') {
        // Or send user to this page
        res.redirect('/phase-2-round-4/account/sign-in')
    } else {
        // Or send user to this page
        res.redirect('/phase-2-round-4/childcare-calculator/what-youll-need')
    }
})

// universal credit account logic
router.post('/phase-2-round-4/sign-in-or-create-account-form-2', function (req, res) {
    ...
    if (option === 'create-account') {
        ...
        // Or send user to this page
        res.redirect('/phase-2-round-4/universal-credit/name')
    }
})

// replace passport account logic
router.post('/phase-2-round-4/sign-in-or-create-account-form-4', function (req, res) {
    ...
    if (option === 'create-account') {
        ...
        // Or send user to this page
        res.redirect('/phase-2-round-4/replace-your-passport/do-you-live-in-the-uk')
    }
})

// masthead account logic
router.post('/phase-2-round-4/sign-in-or-create-account-form-3', function (req, res) {
    ...
    if (option === 'create-account') {
        ...
        // Or send user to this page
        res.redirect('/phase-2-round-4/account/check-account-enter-email')
    }
})
...
router.post('/phase-2-round-4/check-account-resume', function (req, res) {
    ...
    console.log('previous email is: ' + oldEmail)
    if (email === oldEmail && email !== '') {
        res.redirect('/phase-2-round-4/enter-password')
    } else {
        if (signin === "resume") {
            //oldEmail = email
            //req.session.data['email-address-used'] = email
            res.redirect('/phase-2-round-4/account-not-found-resume')
        } else {
            oldEmail = email
            req.session.data['email-address-used'] = email
            res.redirect('/phase-2-round-4/check-email')
        }
    }
})
...
// Create an Account or Sign in page Check if you have a GOV.UK Account route
// create-account-enter-email.html
router.post('/phase-2-round-4/create-account', function (req, res) {
    email = req.session.data['email-address']
    oldEmail = req.session.data['email-address-used'] || ""
    signin = req.session.data['sign-in'] || ""
    console.log('v5 new email is: ' + email)
    console.log('previous email is: ' + oldEmail)
    if (email === oldEmail && email !== '') {
        res.redirect('/phase-2-round-4/account/enter-password')
    } else {
        if (signin === "resume") {
            res.redirect('/phase-2-round-4/account/account-not-found')
        } else {
            oldEmail = email
            req.session.data['email-address-used'] = email
            res.redirect('/phase-2-round-4/account/check-email')
        }
    }
})
...
// Create an Account or Sign in page Sign in route
// sign-in.html
router.post('/phase-2-round-4/check-account-sign-in', function (req, res) {
    email = req.session.data['email-address']
    oldEmail = req.session.data['email-address-used'] || ""
    signin = req.session.data['sign-in'] || ""
    console.log('new email is: ' + email)
    ...
    if (email === oldEmail && email !== '') {
        ...
        if (signin === "signin") {
            res.redirect('/phase-2-round-4/account/account-not-found-sign-in')
        } else {
            oldEmail = email
            req.session.data['email-address-used'] = email
            res.redirect('/phase-2-round-4/account/account-not-found-sign-in')
...
// Create an Account or Sign in page Check if you have a GOV.UK Account route
// check-account-enter-email.html
router.post('/phase-2-round-4/check-account', function (req, res) {
    email = req.session.data['email-address']
    oldEmail = req.session.data['email-address-used'] || ""
    signin = req.session.data['sign-in'] || ""
    console.log('new email is: ' + email)
...
// round 2 Childcare calc add additional child 1 
// child-1-details.html
router.post('/phase-2-round-4/child-1-add', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
    ...
    if (addchild1 === 'yes') {
        res.redirect('/phase-2-round-4/childcare-calculator/child-2-details')
    } else {
        res.redirect('/phase-2-round-4/childcare-calculator/childcare-costs')
    }
})

// round 2 Childcare calc add additional child 2 
// child-2-details.html
router.post('/phase-2-round-4/child-2-add', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
    ...
    if (addchild2 === 'yes') {
        res.redirect('/phase-2-round-4/childcare-calculator/child-3-details')
    } else {
        res.redirect('/phase-2-round-4/childcare-calculator/childcare-costs')
    }
})
...
// round 2 Childcare calc add additional child 3 
// child-3-details.html
router.post('/phase-2-round-4/child-3-add', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
...
// round 2 Childcare calc live with partner 
// do-you-live-with-partner.html
router.post('/phase-2-round-4/partner-check', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
    ...
    if (partner === 'yes') {
        res.redirect('/phase-2-round-4/childcare-calculator/are-you-in-paid-work')
    } else {
        res.redirect('/phase-2-round-4/childcare-calculator/are-you-in-paid-work')
    }
})
...
router.post('/phase-2-round-4/paid-work-check', function (req, res) {
    ...
    if (empstat === 'Unemployed') {
        res.redirect('/phase-2-round-4/childcare-calculator/check-your-answers')
    } else {
        res.redirect('/phase-2-round-4/childcare-calculator/parent-work-hours')
    }
})

// round 2 UC employment status check
// employment-status.html
router.post('/phase-2-round-4/employment-status-check', function (req, res) {
    // Get the answer from session data
    // The name between the quotes is the same as the 'name' attribute on the input elements
    // However in JavaScript we can't use hyphens in variable names
    ...
    if (empstat === 'Unemployed') {
        res.redirect('/phase-2-round-4/universal-credit/childcare-provider')
    } else {
